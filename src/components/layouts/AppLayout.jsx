...
const AppLayout = () => {
    ...
    if (e.key === "Enter") {
      ...
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_URL}/productos/email`,
          {
            method: "POST",
            headers: {
  ...
  return (
    <>
          ...
          <div className="px-3 py-2 lg:px-5 lg:pl-3">
            <div className="flex items-center justify-between px-4">
              ...
              <ul className="flex gap-2" role="none">
                <li>
                  <a
                    href="https://www.facebook.com/share/1CqAqaxUYA/?mibextid=wwXIfr"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/suplementos_n.v/?hl=es"
                    className={styles.menuitem}
                    role="menuitem"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="flex items-center justify-between px-15">
              ...
              <div className="flex items-center">
                <ul className="flex gap-6 text-blue-800 text-lg font-medium">
                  <li>
                    <a href="/" className={styles.menuitem} role="menuitem">
                      Inicio
                    </a>
                  </li>
                  <li className="relative group">
                    ...
                    <ul className="absolute left-0 hidden group-hover:block bg-gray-800 shadow-lg rounded-lg w-40 z-10">
                      <li>
                        <Link
                          to="/productos/a6028cec-3718-4e4f-90b0-44cecbe430d9"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Under Armour
                        </Link>
                      </li>
                      <li>
                        <Link
                          to="/productos/53ab37e4-9ab8-4286-9f47-0641feb624b0"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          GymShark
                        </Link>
                  ...
                  <li className="relative group">
                    ...
                    <ul className="absolute left-0 hidden group-hover:block bg-gray-800 shadow-lg rounded-lg w-45 z-10">
                      <li>
                        <Link
                          to="/productos/a9aa671a-62ab-4312-bb84-093ee4a7cf1d"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          GymShark
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/e49d2aa4-394a-4072-8ebc-f800265bf497"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Under Armour
                        </Link>
                  ...
                  <li>
                    <Link
                      to="/productos/58d6f966-bc95-47d1-b9df-86c649bb4048"
                      className={styles.menuitem}
                      role="menuitem"
                    >
                      Accesorios
                  ...
                  <li className="relative group">
                    ...
                    <ul className="absolute left-0 hidden group-hover:block bg-gray-800 shadow-lg rounded-lg w-60 z-10">
                      <li>
                        <Link
                          to="/productos/ec5d1aa5-d230-41aa-a7dc-fade78b0a441"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                      ...
                      <li>
                        <Link
                          to="/productos/061950c4-73f1-410a-95f9-22a7a5f5558d"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Vitaminas
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/e6f0b7cf-7aef-4892-929c-bda5b1009e0a"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Carbohidratos
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/deb95bec-5df4-4e5b-99a8-ef6243c3a010"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Glutamina
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/fe41ea76-e1c0-4b0a-9af6-561102ad4490"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Gainer
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/1907451b-4a87-4b53-875b-79b8b7735ed5"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Creatina
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/a96452d8-71af-4bc1-8cc5-c1c9950d9639"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Termogenicos
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/441a656e-f89d-458f-8444-cfd965d1d7b2"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Proteínas
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/97d25b2d-71b4-11ea-8d93-0603130a05b8"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Prework-Out
                        </Link>
                      ...
                      <li>
                        <Link
                          to="/productos/97d25b14-71b4-11ea-8d93-0603130a05b8"
                          className={`${styles.menuitem} block px-4 py-2 hover:bg-gray-100 rounded-lg`}
                        >
                          Bcaa/Aminos
                        </Link>
              ...
              <li className="relative">
                {showInput ? (
                  <input
                    ...
                    onKeyDown={handleKeyDown}
                    placeholder="Buscar..."
                    className="border bg-white text-black rounded px-2 py-1 w-full"
                  />
                ) : (
                  <img
                    src="/icons/vaso.png"
      ...
      <div onClick={closeMenu} className="pt-[56px] md:pt-[100px] w-full">
        <Outlet />
      </div>
      ...
      <footer className="bg-black text-white">
        <div className="container mx-auto px-6 py-10 flex flex-col md:flex-row gap-8">
          <div className="md:w-1/2">
            ...
            <div className="text-sm space-y-2 mt-4">
              <p>
                <span className="font-semibold">Dirección:</span> Blvd. Gral.
                Juan Zertuche 937, Valle Dorado, 22890 Ensenada, Baja
                california, Mexico
              </p>
              <p>
                <span className="font-semibold">Dirección:</span> Av. Diamante
                2057, Hidalgo, 22880 Ensenada, Baja california, Mexico
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center bg-black text-center py-4 text-sm text-white">
          <p>
            &copy; 2025 SUPLEMENTOSN.V. Todos los derechos reservados. Powered
            by <span className="font-semibold">SWS Souls Web Solutions</span>.
          </p>
        </div>
      </footer>
    </>
